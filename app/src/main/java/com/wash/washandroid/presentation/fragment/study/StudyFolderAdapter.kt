...
class FolderAdapter(
    private var folders: List<String>, private val onItemClick: (Int, String) -> Unit
    ...
    class FolderViewHolder(itemView: View, private val onItemClick: (Int, String) -> Unit) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(folderName: String) {
            ...
            itemView.setOnClickListener {
                ...
                onItemClick(adapterPosition, clickedFolderName)  // 추출한 텍스트를 onItemClick 함수에 전달
            }
        }
    }
}
